...
public class TrainInfoDto {
    ...
    private StationInfoDto originStationInfo;

    @JsonProperty("InitialTrainStationInfo")
    private StationInfoDto initialTrainStationInfo;
    ...
    private StationInfoDto destinationStationInfo;

    @JsonProperty("FinalTrainStationInfo")
    private StationInfoDto finalTrainStationInfo;
    ...
    private Object trainClassNames; // Может быть null
}
