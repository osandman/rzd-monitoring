...
public class StationService extends BaseService {
    ...
    public StationDto findStation(String namePart) {
        ...
        MultiValueMap<String, String> params = new LinkedMultiValueMap<>() {{
            put("stationNamePart", List.of(namePart));
            put("lang", List.of(lang));
        }};
        String stationsStr = requestProcess.callGetRequest(STATION_ENDPOINT, params);
        List<Station> stations = JsonParser.parseValues(stationsStr, Station.class);
        return getStationDto(namePart, stations);
    }

    private static StationDto getStationDto(String namePart, List<Station> stations) {
